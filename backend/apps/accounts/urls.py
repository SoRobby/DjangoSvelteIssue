...
urlpatterns = [
    ...
    # path('delete-account/', views.soft_delete_account_view, name='soft-delete-account'),
    # path('delete-account/', views.hard_delete_account_view, name='hard-delete-account'),
