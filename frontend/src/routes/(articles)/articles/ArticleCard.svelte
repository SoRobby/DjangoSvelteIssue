...
<article class="relative isolate flex flex-col gap-8 lg:flex-row">
	...
	<div>
		<div class="flex items-center gap-x-4 text-xs">
			<time datetime="2020-03-16" class="text-muted">Mar 16, 2020</time>
			<Badge variant="secondary">Marketing</Badge>
		</div>
		<div class="group relative max-w-xl">
			<h3 class="mt-3 text-lg font-semibold leading-6 text-primary group-hover:text-muted">
				<a href="/articles/article">
					<span class="absolute inset-0"></span>
					Boost your conversion rate
				</a>
			</h3>
			<p class="mt-5 text-sm leading-6 text-tertiary">
